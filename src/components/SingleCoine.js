...
// CSS
import styles from './SingleCoine.module.css'

const SingleCoine = props => {
    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.price}>${current_price.toLocaleString()}</p>
            ...
            <p className={styles.marketCap}>${market_cap.toLocaleString()}</p>
        </div>
    
    );
};

export default React.memo(SingleCoine);